...
We observed that when four 1.5 V battery is connected in series connection, the multimeter showed overall voltage of 6 V.
Hence, when the batteries are connected in series, overall voltage across the circuit is the sum of the voltage
...
Write a brief note about the results of simulating a simple electric circuit by connecting components directly..
 lastly when there is no resistance the light glows the broghtest but gets damaged due to current overflow'
...
a.	R2: _________1.4_______ V: ______1mv_______    Measured Voltage: _________583_______

b.	R2: __________1.5______ V: _____2mv________    Measured Voltage: ________1.2______

c.	R2: __________2______ V: ______1mv_______    Measured Voltage: ________666mv________
